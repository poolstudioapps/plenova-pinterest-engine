...
const FR = {
  ...
  "hooks.tierHint": "Les hooks des comptes suivis, classés par les vues du carrousel qu'ils ouvraient : S = le top 10 %, D = les 15 % du bas. Clique sur un hook pour tout voir.",
  ...
  "spy.tabDoneStark": "Traités · Mr Stark",
  "spy.tabDoneMousk": "Traités · Mr Mousk",
  "spy.teamFor": "Tu traites pour {team}",
  "spy.teamPick": "Tu traites pour :",
  "spy.teamNoneTitle": "Choisis ton équipe",
  "spy.teamNoneBody": "Mr Stark et Mr Mousk ont chacun leur liste de carrousels à traiter. Choisis en haut à droite pour qui tu traites.",
  ...
  "spy.lastRunInterrupted": "Ce passage s'est arrêté avant la fin : relance le spy.",
  "spy.launch": "Lancer le spy",
  "spy.launchWaiting": "Lancement…",
  "spy.launchRunning": "Passage en cours",
  "spy.launchHowTo": "Comment ça marche ?",
  "spy.launchHelpTitle": "Lancer le spy depuis l'app",
  "spy.launchHelp1": "Le bouton ouvre le dossier « Plenova Spy » de cet ordinateur. Il faut l'avoir activé une fois : double-clique sur « Lancer le spy.bat » dans ce dossier (Windows retient alors son emplacement). Si le dossier change de place, refais ce double-clic.",
  "spy.launchHelp2": "Au clic, le navigateur demande « Ouvrir Plenova Spy ? » : accepte (tu peux cocher « Toujours autoriser »). La fenêtre du spy s'ouvre et cette page suit le passage toute seule.",
  "spy.launchHelp3": "Seulement sur un PC Windows qui a le dossier : depuis un téléphone ou un autre ordinateur, rien ne se lance.",
  "spy.launchHelpLater": "Plus tard",
  "spy.launchHelpGo": "C'est fait, lancer",
  "spy.launchMissingTitle": "Rien ne s'est lancé ?",
  "spy.launchMissingBody": "Sur cet ordinateur, double-clique une fois sur « Lancer le spy.bat » dans le dossier « Plenova Spy » : ça active le bouton. Puis réessaie. Si la fenêtre du spy s'est ouverte mais qu'elle attend un code d'accès, colle-le (Spy > Comptes > Ordinateurs).",
  "spy.removePost": "Supprimer du Spy",
  "spy.removePostConfirm": "Confirmer : images effacées, il ne reviendra plus",
  "spy.postRemoved": "Carrousel de @{name} supprimé du Spy : ses images sont effacées, ses hooks restent dans Hooks, et le spy ne le rapportera plus.",
  "spy.historyPending": "Slides au prochain passage",
  "spy.historyPendingHint": "Carrousel importé avec l'historique : seule sa couverture est gardée pour l'instant. Ses slides arrivent au prochain passage du spy, il pourra alors être refait.",
  "spy.neverRan": "Le spy n'a pas encore tourné. Lance-le depuis le dossier « Plenova Spy » : double-clic sur « Lancer le spy.bat ».",
  "spy.stale": "Pas de passage depuis {when}. Lance le spy depuis le dossier « Plenova Spy » : double-clic sur « Lancer le spy.bat ».",
  "spy.sort": "Trier",
  ...
  "spy.accountsHint": "Le spy visite ces comptes à chaque passage, depuis n'importe quel ordinateur autorisé. Ajoute, retire ou mets en pause ici : il suit tout seul au passage suivant.",
  ...
  "spy.statusOk": "{n} carrousel(s) relevé(s)",
  ...
  "spy.team": "Équipe",
  "spy.accountsHintOurs": "Le spy visite aussi ces comptes à chaque passage, pour leurs stats. Ils n'apparaissent jamais dans le Spy ni dans les hooks.",
  "spy.removeAccountOurs": "Retirer (efface ses stats)",
  "spy.statusOkOurs": "{n} post(s) relevé(s)",
  "spy.statusEmptyOurs": "aucun post relevé",
  "spy.computers": "Ordinateurs",
  "spy.computersHint": "Chaque ordinateur qui lance le spy a son propre code d'accès : révoque-en un pour couper cet ordinateur sans toucher aux autres.",
  "spy.computerPlaceholder": "Nom de l'ordinateur, ex. PC de Julie",
  "spy.computerAdd": "Autoriser un ordinateur",
  "spy.computerToken": "Code d'accès pour « {name} »",
  "spy.computerTokenHint": "Colle-le quand le spy le demande, au premier lancement sur cet ordinateur. Il ne sera plus jamais affiché : copie-le maintenant.",
  "spy.copy": "Copier",
  "spy.copied": "Copié",
  "spy.computerSeen": "dernier passage {when}",
  "spy.computerNever": "jamais lancé",
  "spy.computerRevoke": "Révoquer",
  "spy.computerRevoked": "Révoqué",
  "spy.computersEmpty": "Aucun ordinateur autorisé pour l'instant.",
  "spy.notePlaceholder": "Note",
  "spy.accountCount": "{n} comptes suivis",
  "spy.processTitle": "Refaire ce carrousel",
  "spy.processBody": "Chaque slide est relue par Gemini : son image est refaite, son texte réécrit dans ta voix et tes langues, et chaque photo classée dans la bibliothèque avec sa plante. Une slide Plenova (« perso, j'utilise l'app Plenova… ») est glissée en 4e position. Le carrousel arrive ensuite dans Carrousels, prêt à retoucher et publier.",
