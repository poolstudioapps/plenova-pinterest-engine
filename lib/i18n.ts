...
const FR = {
  ...
  "editor.empty": "Cette slide n'a pas encore de titre en {lang}. Écris-le ici.",
  ...
  "editor.saveFailed": "La slide {n} n'a pas pu être enregistrée : {reason}",
  ...
  "editor.canvasHint": "Double-clic pour écrire · coins pour agrandir · côtés pour la largeur · Alt pour ignorer le magnétisme.",
  "editor.langMissing": "Slides sans titre en {lang} : {n}",
  ...
  "editor.thumbMissing": "Titre manquant dans cette langue",
